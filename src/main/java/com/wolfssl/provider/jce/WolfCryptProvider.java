...
public final class WolfCryptProvider extends Provider {
    ...
    private void registerServices() {
        ...
        if (FeatureDetect.AesXtsEnabled()) {
            ...
            /* AES-XTS aliases follow SunJCE names, the key size is not
             * enforced per alias. No AES_192, XTS-192 not in SP 800-38E. */
        ...
        if (FeatureDetect.RsaEnabled()) {
            ...
            if (FeatureDetect.RsaNoPaddingEnabled()) {
                put("Cipher.RSA/ECB/NoPadding",
