...
public class Rsa extends NativeStruct {
    ...
    /**
     * Raw RSA primitive with no padding. Input and output are the key size.
     * Private decrypt requires input in the range 2 to n - 2 and fails with
     * RSA_OUT_OF_RANGE_E otherwise, whether the other types are range
     * checked depends on the native wolfSSL version.
     *
