...
extern "C" {
#endif
#undef com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_SALT_SIZE
#define com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_SALT_SIZE 8L
#undef com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_ITERATION_COUNT
#define com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_ITERATION_COUNT 10000L
#undef com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_IV_LENGTH
#define com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_IV_LENGTH 12L
#undef com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_TAG_LENGTH
#define com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_TAG_LENGTH 128L
#undef com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_KEY_LENGTH
#define com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_KEY_LENGTH 32L
#undef com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_HMAC_KEY_LENGTH
#define com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_HMAC_KEY_LENGTH 32L
#undef com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_MAX_CHAIN_COUNT
#define com_wolfssl_provider_jce_WolfSSLKeyStore_WKS_MAX_CHAIN_COUNT 100L
